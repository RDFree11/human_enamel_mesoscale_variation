...
ang       = char(197); 
cmapstr   = {'bone','autumn','autumn','autumn'};
panl      = {'A','B','C','D','E','F','G','H','I'};
clims     = {[0,8],[35,55],[9.448,9.458],[6.85,6.92]};
dlim_abs  = [[0,8];[35,55];[9.448,9.458];[6.85,6.92]];
...
% Import data and select data range
...
AMatrix=AMatrix(:,x_range);
CMatrix=CMatrix(:,x_range);
Size121Matrix=Size121Matrix(:,x_range);
...
%     imagesc(xv,yv,M(:,:,ii));
    ...
    if ii>1    
        ...
        text(ax(ii),2,.85,cbar_str1{ii},...
            'Units','normalized',...
            'FontSize',FontSize_Tick,...
            'Color','k',...
            'HorizontalAlignment','center');
        text(ax(ii),1.45,.85,cbar_str2{ii},...
            'Units','normalized',...
            'FontSize',FontSize_Tick,...
            'Color','k',...
            'HorizontalAlignment','center');
        ...
        text(ax(ii),1.5,.85,cbar_str1{ii},...
            'Units','normalized',...
            'FontSize',FontSize_Tick,...
            'Color','k',...
            'HorizontalAlignment','center');
...
imagesc(ax(6),yv,xv,rot90(G,3),'alphadata',alpha_val*rot90(tmap,3));
daspect([yAsp,xAsp,1])
colormap(ax(6),cmap);
caxis(ax(6),[0.5,3.5]);
ax(6).Visible = 'off';
...
text(0,1.3,panl{5},'Units','normalized','FontSize',FontSize_Panel,'Color','k');
